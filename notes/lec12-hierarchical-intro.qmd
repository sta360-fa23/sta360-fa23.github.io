...
mathScores = read_csv("../data/mathScores.csv")
```
...
Exercise: Imagine variability among scores is the same across all schools, but there does exist heterogeneity in the mean scores of the schools. Write down a model for to describe this using the normal distribution.
...
#| echo: false
#| eval: false
# note this is very different from p(theta51 > theta41 | data): 
