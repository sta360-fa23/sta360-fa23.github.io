...
- What is the probability the mean score of school 51 is higher than the mean score of school 41?
...
<!-- p(\theta_j | \cdot) &\propto p(\theta_j | \mu, \tau^2) \prod_{i = 1}^m p(y_{i,j}|\theta_j, \sigma^2) -->
<!-- \end{aligned} -->
<!-- $$ -->
...
- What's $p(\theta_{51} > \theta_{41} | \text{data})$?
