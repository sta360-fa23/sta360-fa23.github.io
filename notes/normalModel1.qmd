...
But how do we choose $p(\sigma^2)$ to be conjugate? We can proceed in multiple ways: one is noting that the integral is really a convolution of normals and is therefore a normal density (for some intution, see [this 3Blue1Brown video on convolutions](https://www.youtube.com/watch?v=IaSGqQa5O-M). Another way is perhaps more straightforward: consider $\mu$ fixed.
