...
- `rstanarm` contains a host of functions to make Bayesian R model fitting easy. See [https://mc-stan.org/rstanarm/articles/](https://mc-stan.org/rstanarm/articles/) for a full list of tutorials.
